...
export interface IFinalizeJobWorkerConstructProps {
  dynamoDbTable: Table
  eventBus: EventBus
}
 ...
 *
 */
export class FinalizeJobWorkerConstruct extends Construct {
  /**
   *
   */
  constructor(scope: Construct, id: string, props: IFinalizeJobWorkerConstructProps) {
    super(scope, id)
    const dlq = this.createFinalizeJobWorkerDlq(this, id)
    const queue = this.createFinalizeJobWorkerQueue(this, id, dlq)
    this.createFinalizeJobWorkerFunction(this, id, props.dynamoDbTable, queue)
    this.createFinalizeJobWorkerRoutingRule(this, id, props.dynamoDbTable, props.eventBus, queue)
  }

  /**
   *
   */
  private createFinalizeJobWorkerDlq(scope: Construct, id: string): Queue {
   ...
   *
   */
  private createFinalizeJobWorkerQueue(scope: Construct, id: string, dlq: Queue): Queue {
   ...
   *
   */
  private createFinalizeJobWorkerFunction(
    scope: Construct,
    id: string,
    dynamoDbTable: Table,
    queue: Queue,
   ...
   *
   */
  private createFinalizeJobWorkerRoutingRule(
    scope: Construct,
    id: string,
    dynamoDbTable: Table,
    eventBus: EventBus,
