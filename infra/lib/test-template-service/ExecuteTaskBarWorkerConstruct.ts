...
export interface IExecuteTaskBarWorkerConstructProps {
  dynamoDbTable: Table
  eventBus: EventBus
}
 ...
 *
 */
export class ExecuteTaskBarWorkerConstruct extends Construct {
  /**
   *
   */
  constructor(scope: Construct, id: string, props: IExecuteTaskBarWorkerConstructProps) {
    super(scope, id)
    const dlq = this.createExecuteTaskBarWorkerDlq(this, id)
    const queue = this.createExecuteTaskBarWorkerQueue(this, id, dlq)
    this.createExecuteTaskBarWorkerFunction(this, id, props.dynamoDbTable, queue)
    this.createExecuteTaskBarWorkerRoutingRule(this, id, props.dynamoDbTable, props.eventBus, queue)
  }

  /**
   *
   */
  private createExecuteTaskBarWorkerDlq(scope: Construct, id: string): Queue {
   ...
   *
   */
  private createExecuteTaskBarWorkerQueue(scope: Construct, id: string, dlq: Queue): Queue {
   ...
   *
   */
  private createExecuteTaskBarWorkerFunction(
    scope: Construct,
    id: string,
    dynamoDbTable: Table,
    queue: Queue,
   ...
   *
   */
  private createExecuteTaskBarWorkerRoutingRule(
    scope: Construct,
    id: string,
    dynamoDbTable: Table,
    eventBus: EventBus,
